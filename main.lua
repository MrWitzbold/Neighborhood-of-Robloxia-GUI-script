...
local astolfo_pic = Instance.new("ImageLabel")
...
main.Name = "main"
main.Parent = h4x
main.BackgroundColor3 = Color3.fromRGB(109, 14, 44)
...
title.Text = "Neighborhood of Robloxia GUI"
...
f_to_noclip.Position = UDim2.new(0, 0, 0.62449795, 0)
f_to_noclip.Size = UDim2.new(0, 281, 0, 24)
...
speed_set.Position = UDim2.new(0, 0, 0.122489959, 0)
...
speed_textbox.Position = UDim2.new(0.373665482, 0, 0.122489959, 0)
...
t_to_teleport.Position = UDim2.new(0, 0, 0.214859426, 0)
...
teleport_to_player.Position = UDim2.new(0, 0, 0.29919678, 0)
...
player_textbox.Position = UDim2.new(0.373665482, 0, 0.29919678, 0)
...
TextLabel.Position = UDim2.new(0, 0, 0.379518092, 0)
...
fly.Position = UDim2.new(0, 0, 0.479919672, 0)
fly.Size = UDim2.new(0, 281, 0, 24)
...
astolfo_pet.Position = UDim2.new(0, 0, 0.540160656, 0)
...
astolfo_pic.Name = "astolfo_pic"
astolfo_pic.Parent = main
astolfo_pic.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
astolfo_pic.BackgroundTransparency = 1.000
astolfo_pic.Position = UDim2.new(0, 0, 0.710843384, 0)
astolfo_pic.Size = UDim2.new(0, 155, 0, 144)
astolfo_pic.Image = "rbxassetid://6704510455"
astolfo_pic.ImageTransparency = 0.400
...
local function MTUE_fake_script() -- teleport_to_player.LocalScript 
	...
	function do_stuff()
		local localplayer = game.Players.LocalPlayer
		local player = nil
		local player_name = script.Parent.Parent.player_textbox.Text:lower()
